    ...
    <div class="bg-light rounded mx-auto my-5 p-3" style="width: 400px;">
        ...
        <form method="POST" action="edit-account.php">
            ...
            <div class="my-3">
                ...
                <input type="text" class="form-control" name="username-input" placeholder="Enter username" minlength="8" maxlength="30" value="<?php echo $user[1]; ?>" required>
            </div>
            <div class="my-3">
                <label for="password-input">Password</label>
                <input type="password" class="form-control" name="password-input" placeholder="Type password" minlength="8" maxlength="16" value="<?php echo $user[2]; ?>" required>
            </div>
            <div class="row">
